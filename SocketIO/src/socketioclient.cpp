...
bool SocketIoClient::connectToServer(const std::string& url, std::map<std::string,std::string>& query)
{
    bool ret = true;
    try
    {
...
bool SocketIoClient::listenForEvent(const std::string& eventName, const sio::socket::event_listener& callback)
{
    bool ret = true;
    try
    {
...
bool SocketIoClient::listenForEvent(const std::string& eventName, const sio::socket::event_listener_aux& callback)
{
    bool ret = true;
    try
    {
